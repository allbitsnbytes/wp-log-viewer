					...
					content = (
						React.createElement("div", {className: "viewer-pane"}, 
							...
							React.createElement("div", {className: "entries-list-header"}, 
								...
								React.createElement("span", {className: "entries-count"},  entries.length === 1 ? entries.length + ' entry' : entries.length + ' entries')
							), 
					...
					if (this.state.debugging.enabled) {
						if (this.state.debugging.simulating) {
							content = (
								React.createElement("div", {className: "viewer-pane"}, 
									React.createElement("div", {className: "content"}, 
										React.createElement("p", null, "The ", React.createElement("strong", null, "debug.log file does not exist"), " or was not found."), 
							...
							content = (
								React.createElement("div", {className: "viewer-pane"}, 
									React.createElement("div", {className: "content"}, 
										React.createElement("p", null, "Debugging is enabled. However, the ", React.createElement("strong", null, "debug.log file does not exist"), ".")
									)
								)
							);
						}
						...
						content = (
							React.createElement("div", {className: "viewer-pane"}, 
								React.createElement("div", {className: "content"}, 
									React.createElement("p", null, React.createElement("strong", null, "Debugging is currently ", React.createElement("span", {className: "highlight"}, "disabled"), ".")), 
	...
	render: function() {
		...
		return (
			React.createElement("span", {className:  className }, 
				"debug:  ", React.createElement("strong", {className: "status"},  status )
			)
		);
	}
});
...
React.render(
	React.createElement(wplv.App, {user:  WPLOGVIEWER.user_id, settings:  WPLOGVIEWER.settings}),
