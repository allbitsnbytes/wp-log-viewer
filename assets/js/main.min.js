 ...
 */
var DebugStatus = React.createClass({displayName: "DebugStatus",
	...
	render: function() {
		...
		return (
			React.createElement("span", {className:  className }, 
				"debug: ", React.createElement("strong", null,  simulating,  status )
			)
		);
	}
});
 ...
 */
var GroupEntry = React.createClass({displayName: "GroupEntry",
	...
	render: function() {
		...
		if (this.state.showDetails) {
			...
			for (var key in group.entries) {
				...
				groupEntryDetails.push((
					React.createElement(TimeStamp, {date:  entryDate })
				));
			}
			...
			groupDetails = (
				React.createElement("div", {className: "group-entry-details active"}, 
					React.createElement("div", {className: "details"}, 
						...
						React.createElement("p", null, "Date and time errors occured:"), 
						 groupEntryDetails 
					)
				)
			);
		...
		return (
			React.createElement("div", {className: "group-entry"}, 
				React.createElement(TimeStamp, {date:  group.date}), 
	...
	render: function() {
		...
		return (
			React.createElement("div", {className:  classes }, 
				React.createElement(TimeStamp, {date:  this.props.date}), 
 ...
 * Display log entries
 */
var LogGroupView = React.createClass({displayName: "LogGroupView",
	...
	render: function() {
		...
		for (var key in groups) {
			groupSections.push((
				React.createElement(GroupEntry, {group:  groups[key] })
			));
		}
 ...
 * Display log entries
 */
var LogListView = React.createClass({displayName: "LogListView",
	...
	render: function() {
		...
		if (entries.length) {		
			var logEntries = entries.map(function(entry) {
				...
				return (
					React.createElement(LogEntry, {date:  entryDate, message:  entry.message})
				);
			});
 ...
 */
var PrettyFilesize = React.createClass({displayName: "PrettyFilesize",
	...
	render: function() {
		return (
			React.createElement("div", {className: "search-group"}, 
				...
				React.createElement("input", {type: "text", name: "q", ref: "q", className: "search-field", placeholder: "Search ...", onChange:  this.handleSearch})
			)
		);
	}
});
 ...
 */
var ViewAction = React.createClass({displayName: "ViewAction",
		...
		if (className === 'active') {
			return (
				React.createElement("li", {className:  className }, 
					React.createElement("a", {href: "#", onClick:  this.handleLinkClicked, title:  this.props.nav.label}, React.createElement("i", {className:  icon }), " ",  this.props.nav.label)
				)
			);
		} else {
			return (
...
var ViewActionGroup = React.createClass({displayName: "ViewActionGroup",
	...
	render: function() {
		...
		var options = group.options.map(function(option) {
			...
			return (
				React.createElement(ViewAction, {notify:  this.updateSelected, selected:  selected, nav:  option })
			);
		}.bind(this));
 ...
 */
var ViewSidebar = React.createClass({displayName: "ViewSidebar",
	...
	render: function() {
		if (this.props.viewer) {
			...
			var menuOptions = defaultMenuOptions.map(function(menuGroup) {
				return (
					React.createElement(ViewActionGroup, {group:  menuGroup })
				);
			});
			...
			return (
				React.createElement("div", {className: "sidebar"}, 
					...
					React.createElement("div", {className: "last-modified"}, 
						...
						React.createElement(TimeStamp, {date:  lastModifiedDate })
					), 
			
					React.createElement("div", {className: "log-filesize"}, 
						React.createElement("strong", null, "Filesize"), React.createElement("br", null), 
						React.createElement(PrettyFilesize, {filesize:  this.props.viewer.state.filesize})
					)
				)
			);
		}
			...
			if (this.state.debugDetected || this.state.simulating) {
				if (this.state.found) {
					...
					var viewHeader = (
						React.createElement("div", {className: "view-header"}, 
							React.createElement("h2", null, "Log Viewer ", React.createElement(DebugStatus, {enabled:  this.state.debugEnabled, detected:  this.state.debugDetected, simulating:  this.state.simulating})), 
							React.createElement(SearchField, {viewer:  this })
						)
					);
					...
					if (this.state.view == 'list') {
						return (
							React.createElement("div", {id: "viewer-pane"}, 
								 viewHeader, 

								React.createElement(LogListView, {entries:  entries }), 
								React.createElement(ViewSidebar, {viewer:  this })
							)
						);
					} else {
						return (
							React.createElement("div", {id: "viewer-pane"}, 
								...
								React.createElement(LogGroupView, {entries:  entries }), 
								React.createElement(ViewSidebar, {viewer:  this })
							)
						);
					}
					...
					if (this.state.debugEnabled) {
						...
						return (
							React.createElement("div", {id: "viewer-pane"}, 
								...
								React.createElement("p", null, "For more info: ", React.createElement("a", {href: "https://codex.wordpress.org/Debugging_in_WordPress", target: "_blank"}, "Debugging In Wordpress"))
							)
						);
					}
				}
				...
				return (
					React.createElement("div", {id: "viewer-pane"}, 
						...
						React.createElement("p", null, "Sorry, we could not detect if debugging is enabled or disabled.  We can simulate the status of WP_DEBUG."), 
						
						React.createElement("p", null, React.createElement("strong", null, "How you would like to proceed?")), 
						
						React.createElement("p", null, 
							React.createElement("a", {href: "#", onClick:  this.pretendDebugEnabled, className: "enable-debugging-btn"}, React.createElement("i", {className: "fa fa-arrow-circle-right"}), " Enabled"), 
							React.createElement("a", {href: "#", onClick:  this.pretendDebugDisabled, className: "disable-debugging-btn"}, React.createElement("i", {className: "fa fa-arrow-circle-right"}), " Disabled")
						), 
						React.createElement("br", null), 
