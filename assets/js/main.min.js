 ...
 */
wplv.App = React.createClass({displayName: "App",
	...
	showDebugHelp: function() {
		return (
			React.createElement("div", null, 
				React.createElement("p", null, "To turn on debugging, add the following to your wp-config.php file."), 

				React.createElement("p", {className: "code-snippet"}, 
					"define('WP_DEBUG', true);", React.createElement("br", null), 
					"define('WP_DEBUG_LOG', true);", React.createElement("br", null), 
					"define('WP_DEBUG_DISPLAY', false);"
				), 

				React.createElement("p", null, "For more information visit ", React.createElement("a", {href: "https://codex.wordpress.org/Debugging_in_WordPress", target: "_blank"}, "Debugging In Wordpress"))
			)
		);
	},
	...
	render: function() {
		...
		if (this.ready) {
			if (this.state.debugging.detected || this.state.debugging.simulating) {
				if (this.state.log.found) {
					...
					debugStatus = (
						React.createElement(wplv.DebugStatus, {debugging:  this.state.debugging})
					);
					...
					if (this.state.log.view === 'group') {
						...
						view = ( React.createElement(wplv.GroupViewer, {entries:  entries }) );
					} else {
						count = entries.length;
						view = ( React.createElement(wplv.ListViewer, {entries:  entries }) );
					}

					content = (
						React.createElement("div", {className: "viewer-pane"}, 
							React.createElement(wplv.Search, {app:  this }), 

							React.createElement("div", {className: "entries-list-header"}, 
								React.createElement("h3", null, "Log Entries"), 
								React.createElement("span", {className: "entries-count"},  count === 1 ? count + ' entry' : count + ' entries')
							), 
					...
					sidebar = (
						React.createElement(wplv.Sidebar, {app:  this })
					);
				} else {
					if (this.state.debugging.enabled) {
						if (this.state.debugging.simulating) {
							content = (
								React.createElement("div", {className: "viewer-pane"}, 
									React.createElement("div", {className: "content"}, 
										React.createElement("p", null, "Currently ", React.createElement("strong", {className: "debug-status-simulating"}, "simulating"), ".  The ", React.createElement("strong", null, "debug.log file does not exist or was not found.")), 
										
										React.createElement("ul", {className: "inline-buttons"}, 
											React.createElement("li", null, React.createElement("a", {href: "#", onClick:  function(e) { e.preventDefault(); this.stopSimulation(); }.bind(this), className: "stop-simulation-btn"}, React.createElement("i", {className: "fa fa-arrow-circle-right"}), " Stop simulation"))
										)
									)
								)
							);
							...
							content = (
								React.createElement("div", {className: "viewer-pane"}, 
									React.createElement("div", {className: "content"}, 
										React.createElement("p", null, "Debugging is ", React.createElement("strong", {className: "debug-status-enabled"}, "enabled"), ".  However, the ", React.createElement("strong", null, "debug.log file does not exist or was not found."))
									)
								)
							);
						}
						...
						content = (
							React.createElement("div", {className: "viewer-pane"}, 
								React.createElement("div", {className: "content"}, 
									React.createElement("p", null, React.createElement("strong", null, "Debugging is currently ", React.createElement("span", {className: "debug-status-disabled"}, "disabled"), ".")), 
				...
				content = (
					React.createElement("div", {className: "viewer-pane"}, 
						React.createElement("div", {className: "content"}, 
							React.createElement("p", {className: "debugging-unknown"}, "Sorry, we ", React.createElement("strong", null, "could not detect if debugging is enabled or disabled"), "."), 
							React.createElement("br", null), 

							React.createElement("h3", null, "Simulate Debugging?"), 

							React.createElement("p", null, "If you know that debugging is enabled, click below to continue."), 

							React.createElement("ul", {className: "inline-buttons"}, 
								React.createElement("li", null, React.createElement("a", {href: "#", onClick:  function(e) { e.preventDefault(); this.startSimulation(); }.bind(this), className: "start-simulation-btn"}, React.createElement("i", {className: "fa fa-arrow-circle-right"}), " Start simulation"))
							), 

							React.createElement("br", null), 
							React.createElement("p", null, React.createElement("small", null, "** Please note that the status of WP_DEBUG is not actually being changed.  This is just a simulation.")), 
							React.createElement("br", null), 

							React.createElement("h3", null, "How to Enable Debugging?"), 
		...
		return (
			React.createElement("div", {className: "container"}, 
				React.createElement("header", {className: "view-header"}, 
					React.createElement("div", {className: "container"}, 
						React.createElement("h2", null, "Log Viewer ",  debugStatus ), 
						React.createElement(wplv.ErrorLegend, null)
					)
				), 
 ...
 */
wplv.AdminBarNav = React.createClass({displayName: "AdminBarNav",
	...
	render: function() {
		...
		if (this.ready && (this.state.debugging.simulating || this.state.debugging.detected)) {
			...
			summary = (
				React.createElement("div", {className: "summary"}, 
					React.createElement("div", {className:  statusClass + ' ' + status},  status ), 
					React.createElement("div", {className:  errorClass },  this.state.count)
				)
			);
		}
		...
		return (
			React.createElement("div", {className: ""}, 
				React.createElement("a", {href:  this.props.pluginUrl, className: "ab-item"}, "Debug Log ",  summary )
			)
		);
	}
});
 ...
 * Dashboard Widget
 */
wplv.DashboardWidget = React.createClass({displayName: "DashboardWidget",
	...
	render: function() {
		...
		if (this.ready) {
			if (this.state.debugging.detected || this.state.debugging.simulating) {
				if (this.state.log.found) {
					content = (
						React.createElement("ul", {className: "error-types-list"}, 
							React.createElement("li", {className: "php-fatal-error"}, 
								React.createElement("div", {className: "label"}, React.createElement("i", {className: "fa fa-arrow-circle-o-right"}), " Fatal"), 
								React.createElement("div", {className: "count"},  this.state.counts.fatal)
							), 
							React.createElement("li", {className: "php-notice"}, 
								React.createElement("div", {className: "label"}, React.createElement("i", {className: "fa fa-arrow-circle-o-right"}), " Notice"), 
								React.createElement("div", {className: "count"},  this.state.counts.notice)
							), 
							React.createElement("li", {className: "php-warning"}, 
								React.createElement("div", {className: "label"}, React.createElement("i", {className: "fa fa-arrow-circle-o-right"}), " Warning"), 
								React.createElement("div", {className: "count"},  this.state.counts.warning)
							), 
							React.createElement("li", {className: "php-misc"}, 
								React.createElement("div", {className: "label"}, React.createElement("i", {className: "fa fa-arrow-circle-o-right"}), " Misc"), 
								React.createElement("div", {className: "count"},  this.state.counts.misc)
							)
						)
					);
				} else {
					if (this.state.debugging.enabled) {
						if (this.state.debugging.simulating) {
							content = (
								React.createElement("p", null, "Currently ", React.createElement("strong", {className: "debug-status-simulating"}, "simulating"), ". However, the ", React.createElement("strong", null, "debug.log file does not exist or was not found"), ".")
							);
						} else {
							content = (
								React.createElement("p", null, "Debugging is ", React.createElement("strong", {className: "debug-status-enabled"}, "enabled"), ". However, the ", React.createElement("strong", null, "debug.log file does not exist or was not found"), ".")
				...
				content = (
					React.createElement("p", null, "Sorry, we ", React.createElement("strong", null, "could not detect if debugging is enabled or disabled"), ".")
				);
			}
		}
		...
		return (
			React.createElement("div", {className: "container"}, 
				...
				React.createElement("a", {href:  this.props.pluginUrl, className: "action-button"}, React.createElement("i", {className: "fa fa-arrow-circle-right"}), " Go to ", React.createElement("strong", null, "Log Viewer"))
			)
		)
	}
});
 ...
 */
wplv.DebugStatus = React.createClass({displayName: "DebugStatus",
 ...
 */
wplv.ErrorLegend = React.createClass({displayName: "ErrorLegend",

	// Render component
	render: function() {
		return (
			React.createElement("ul", {className: "error-indicator-legend"}, 
				React.createElement("li", {className: "php-fatal-error"}, "Fatal Error"), 
				React.createElement("li", {className: "php-warning"}, "PHP Warning"), 
				React.createElement("li", {className: "php-notice"}, "PHP Notice")
			)
		);	
	}
});
 ...
 */
wplv.GroupEntry = React.createClass({displayName: "GroupEntry",
	...
	render: function() {
		...
		if (group.errorType) {
			...
			errorDetails.push((
				React.createElement("div", {className: "error-type"}, React.createElement("i", {className: "fa fa-angle-right"}), " Type: ", React.createElement("span", {className: "type"},  group.errorType))
			));
		}

		if (group.line) {
			errorDetails.push((
				React.createElement("div", {className: "line-number"}, React.createElement("i", {className: "fa fa-angle-right"}), " Line: ", React.createElement("span", {className: "line"},  group.line))
			));
		}
		
		if (group.filePath) {
			errorDetails.push((
				React.createElement("div", {className: "file-path"}, React.createElement("i", {className: "fa fa-angle-right"}), " File: ", React.createElement("span", {className: "file"},  group.filePath))
			));
		}		
		...
		if (this.state.showDetails) {
			...
			for (var key in group.entries) {
				...
				groupEntryDetails.push((
					React.createElement(wplv.TimeStamp, {date:  entryDate })
				));
			}
			
			if (groupEntryDetails.length > 1) {
				groupLabel = (
					React.createElement("p", null, "Date and time these errors occured:")
				);
			} else {
				groupLabel = (
					React.createElement("p", null, "Date and time this error occured:")
				);
			}

			groupDetails = (
				React.createElement("div", {className: "group-entry-details active"}, 
					React.createElement("div", {className: "details"}, 
						React.createElement("a", {href: "#", className: "hide-group-details", onClick:  this.toggleDetails}, "Hide details"), 
			...
			groupDetails = (
				React.createElement("div", {className: "group-entry-details"}, 
					React.createElement("div", {className: "details"}, 
						React.createElement("a", {href: "#", className: "show-group-details", onClick:  this.toggleDetails}, "More details")
					)
				)
			);
		}
		...
		return (
			React.createElement("div", {className:  entryClasses.join(' ') }, 
				React.createElement("div", {clanssName: "error-legend"}), 
				React.createElement(wplv.TimeStamp, {date:  group.date}), 
				React.createElement("div", {className: "message"}, 
					React.createElement("div", {className: "force-wrap"}, 
						 group.message
					), 
 ...
 */
wplv.GroupViewer = React.createClass({displayName: "GroupViewer",
	...
	render: function() {
		...
		for (var key in groups) {
			groupContent.push((
				React.createElement(wplv.GroupEntry, {group:  groups[key] })
			));
		}

		if (groupContent.length === 0) {
			groupContent = (
				React.createElement("p", null, "No entries found.")
			);
		}

		return (
			React.createElement("div", {className: "group-entries"}, 
				 groupContent 
			)
		);
	}
 ...
 */
wplv.ListViewer = React.createClass({displayName: "ListViewer",
	...
	render: function() { 
		var listContent = this.props.entries.map(function(entry) {
			return (
				React.createElement(wplv.LogEntry, {entry:  entry })
			);
		});
 ...
 * Display a log entry
 */
wplv.LogEntry = React.createClass({displayName: "LogEntry",
	...
	render: function() {
		...
		return (
			React.createElement("div", {className:  entryClasses.join(' ') }, 
				React.createElement(wplv.TimeStamp, {date:  entryDate }), 
				React.createElement("div", {className: "message force-wrap"}, 
 ...
 */
wplv.NavAction = React.createClass({displayName: "NavAction",
	...
	render: function() {
		...
		var link = ( React.createElement("a", {href: "#", onClick:  this.handleLinkClicked, title:  this.props.nav.label}, React.createElement("i", {className:  icon }), " ",  this.props.nav.label) );
 ...
 */
wplv.NavActionGroup = React.createClass({displayName: "NavActionGroup",
	...
	render: function() {
		...
		var options = group.options.map(function(option) {
			...
			return (
				React.createElement(wplv.NavAction, {notify:  this.updateSelected, selected:  selected, nav:  option })
			);
		}.bind(this));

		return (
			React.createElement("div", {className: "menu-group"}, 
 ...
 */
wplv.PrettyFilesize = React.createClass({displayName: "PrettyFilesize",
 ...
 */
wplv.Search = React.createClass({displayName: "Search",
	...
	render: function() {
		...
		if (this.state.query.length >= this.minimumLength) {
			searchQuery = (
				React.createElement("div", {className: "search-query"}, 
					"Searching for ", React.createElement("strong", null,  this.state.query)
				)
			);
		}
		...
		return (
			React.createElement("div", {className: "search-group"}, 
				React.createElement("div", {className: "search-component"}, 
					...
					React.createElement("input", {type: "text", name: "q", ref: "q", className: "search-field", placeholder: "Search for ...", onChange:  this.handleSearch})
				)
			)
		);
	}
 ...
 */
wplv.Sidebar = React.createClass({displayName: "Sidebar",
	...
	render: function() {
		if (this.props.app.ready) {
			...
			var menuOptions = defaultMenuOptions.map(function(menuGroup) {
				return (
					React.createElement(wplv.NavActionGroup, {group:  menuGroup })
				);
			});
			...
			return (
				React.createElement("aside", {className: "sidebar"}, 
					...
					React.createElement("div", {className: "last-modified"}, 
						React.createElement("strong", null, "Last modified"), React.createElement("br", null), 
						React.createElement(wplv.TimeStamp, {date:  lastModifiedDate !== '' ? new Date(lastModifiedDate) : ''})
					), 

					React.createElement("div", {className: "log-filesize"}, 
						React.createElement("strong", null, "Filesize"), React.createElement("br", null), 
						React.createElement(wplv.PrettyFilesize, {filesize:  this.props.app.getFilesize() })
					)
				)
			);
		}
 ...
 */
wplv.TimeStamp = React.createClass({displayName: "TimeStamp",
	...
	render: function() {
		if (this.props.date instanceof Date) {
			...
			return (
				React.createElement("div", {className: "when"}, 
					React.createElement("div", {className: "date"},  currentDate ), 
					React.createElement("div", {className: "time"},  currentTime )
				)
			);
		}
...
if (WPLOGVIEWER.current_page === 'tools_page_wp-log-viewer') {
	React.render(
		React.createElement(wplv.App, {user:  WPLOGVIEWER.user_id, settings:  WPLOGVIEWER.settings, debugging:  WPLOGVIEWER.debug_enabled, pluginUrl:  WPLOGVIEWER.plugin_url}),
		document.getElementById('wplv-container')
	);
} else if (WPLOGVIEWER.current_page === 'dashboard') {
	React.render(
		React.createElement(wplv.DashboardWidget, {debugging:  WPLOGVIEWER.debug_enabled, pluginUrl:  WPLOGVIEWER.plugin_url}),
		document.getElementById('wplv-dashboard-widget-container')
	);
}

React.render(
	React.createElement(wplv.AdminBarNav, {debugging:  WPLOGVIEWER.debug_enabled, pluginUrl:  WPLOGVIEWER.plugin_url}),
