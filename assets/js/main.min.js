		...
		return (
			React.createElement("div", {className: "container"}, 
				React.createElement("header", {className: "view-header"}, 
					React.createElement("h2", null, "Log Viewer ", React.createElement(wplv.DebugStatus, {debugging:  this.state.debugging})), 
...
wplv.Search = React.createClass({displayName: "Search",
	...
	handleSearch: function(e) {
		...
		if (this.props.app.ready) {
			...
			if (typeof query === 'string' && query.length > 2 && this.props.app.searchEntries) {
				this.setState({
					query: query
				});
